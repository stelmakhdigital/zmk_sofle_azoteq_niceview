...
LOG_DBG("TPS43 driver initialized: %s", I2C_DT_SPEC_INST_GET(inst));
LOG_DBG("TPS43 driver initialized: %s", GPIO_DT_SPEC_INST_GET_OR(inst, int_gpios, {0}));
LOG_DBG("TPS43 driver initialized: %s", GPIO_DT_SPEC_INST_GET_OR(inst, rst_gpios, {0}));
LOG_DBG("TPS43 driver initialized: %s", DT_INST_PROP_OR(inst, resolution_x, 0));
LOG_DBG("TPS43 driver initialized: %s", DT_INST_PROP_OR(inst, resolution_y, 0));
LOG_DBG("TPS43 driver initialized: %s", DT_INST_PROP(inst, invert_x));
LOG_DBG("TPS43 driver initialized: %s", DT_INST_PROP(inst, invert_y));
LOG_DBG("TPS43 driver initialized: %s", DT_INST_PROP(inst, swap_xy));

/* Debug: Log how many instances were found */
